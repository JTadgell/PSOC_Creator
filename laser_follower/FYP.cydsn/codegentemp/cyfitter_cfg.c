...
#define BS_IOPINS0_0_VAL ((const uint8 CYFAR *)0x48000CDCu)

/* IOPINS0_7 Address: CYREG_PRT12_DR Size (bytes): 10 */
#define BS_IOPINS0_7_VAL ((const uint8 CYFAR *)0x48000CE4u)
...
#define BS_IOPINS0_1_VAL ((const uint8 CYFAR *)0x48000CF8u)
